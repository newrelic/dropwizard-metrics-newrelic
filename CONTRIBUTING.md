# Contributing to New Relic Dropwizard Reporter
Thanks for your interest in contributing to the New Relic Dropwizard Reporter! We look forward to engaging with you.
...
We'd love to get your contributions to improve New Relic Dropwizard Reporter! Keep in mind when you submit your pull request, you'll need to sign the CLA via the click-through using CLA-Assistant. You only have to sign the CLA one time per project.
...
* Any modifications made to the New Relic Dropwizard Reporter
...
If you can build the New Relic Dropwizard Reporter, you can develop it!
...
## Testing Guidelines
The New Relic Dropwizard Reporter includes the following tests which must pass:
...
## License
By contributing to New Relic Dropwizard Reporter, you agree that your contributions will be licensed under the [License file](LICENSE) in the root directory of this source tree.